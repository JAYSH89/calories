...
class AuthenticationRepository(
    ...
    private val apiKey by lazy {
        environment.getProperty("FIREBASE_API_KEY") ?: IllegalStateException("FIREBASE_API_KEY is missing")
    }

    fun login(firebaseLoginRequest: FirebaseLoginRequest): FirebaseLoginResponse = runBlocking {
        authClient.post("/v1/accounts:signInWithPassword") {
