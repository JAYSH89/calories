...
object AuthenticationObjectHelper {
    ...
    val loginRequest = FirebaseLoginRequest(
        email = "test@example.com",
        password = "testPass123$",
        returnSecureToken = true,
    )

    val loginResponse = FirebaseLoginResponse(
        kind = "test kind",
        localId = "localId",
        email = "test@example.com",
        displayName = "",
    ...
    val refreshRequest = FirebaseRefreshRequest(
        grantType = "refresh_token",
        refreshToken = "refreshToken"
    )

    val refreshResponse = FirebaseRefreshResponse(
        accessToken = "accessToken",
        expiresIn = "3600",
        tokenType = "Bearer",
        refreshToken = "refreshToken",
