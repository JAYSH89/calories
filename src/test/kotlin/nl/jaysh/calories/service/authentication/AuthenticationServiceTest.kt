...
class AuthenticationServiceTest {
    ...
    fun `register should return AuthenticationResponse successful`() {
        val request = AuthenticationObjectHelper.loginRequest
        every { repository.register(request.email, request.password) } returns AuthenticationObjectHelper.loginResponse
    ...
    fun `register invalid email should ApiRequestException`(invalidEmail: String, description: String) {
        val authRequest = AuthenticationObjectHelper.authRequest.copy(email = invalidEmail)
    ...
    fun `register invalid password should ApiRequestException`(invalidPassword: String, description: String) {
    ...
    fun `refresh should return RefreshTokenResponse successful`() {
        ...
        every { repository.refreshToken(refreshRequest) } returns AuthenticationObjectHelper.refreshResponse
